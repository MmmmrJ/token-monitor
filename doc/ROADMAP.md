...
| 关闭到托盘 / 单实例 / autostart | 已完成 | v1.1.3 基线；设置页同步系统真实登录启动状态 |
| MonitorCoordinator | 已完成 | 60s 刷新、单飞 owner 副作用、退避、睡眠唤醒补刷、`monitor:snapshot` |
| 托盘增强 | 已完成 | Provider 摘要、人类可读重置倒计时、切换视图 / Provider、刷新、置顶 |
